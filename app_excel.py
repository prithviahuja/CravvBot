...
pdf_loader=PyPDFLoader(r"C:\Python_Project\feedback_bot\Cravbook.pdf")
pdf_docs=pdf_loader.load()

excel_loader=UnstructuredExcelLoader(r"C:\Python_Project\feedback_bot\Cook_Info_50.xlsx")
...
if a user ask for general queries like, order status, cook availability, cuisine options refer context for the respective cook
